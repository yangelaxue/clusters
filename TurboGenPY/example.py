...
if inputspec != 'cbc' and inputspec != 'vkp' and inputspec != 'kcm' and inputspec != 'pq' and inputspec!='file':
...
exactE = integrate.trapezoid(whichspec(wavenumbers[1:idx]), dx=dk)
print(exactE)
numE = integrate.trapezoid(tkespec[1:idx], dx=dk)
